namespace Principal
{
    partial class ActualizarProducto
    {
        ...
        private void InitializeComponent()
        {
            ...
            btActualizarProducto.Location = new Point(250, 357);
            ...
            btBuscar.Location = new Point(90, 98);
            btBuscar.Name = "btBuscar";
            btBuscar.Size = new Size(121, 34);
            ...
            label1.Location = new Point(37, 151);
            label1.Name = "label1";
            label1.Size = new Size(125, 15);
            label1.TabIndex = 18;
            label1.Text = "Actualiza la referencia:";
            // 
            // label2
            // 
            label2.AutoSize = true;
            label2.Location = new Point(37, 299);
            label2.Name = "label2";
            label2.Size = new Size(127, 15);
            label2.TabIndex = 19;
            label2.Text = "Actualiza el proveedor:";
            // 
            // label3
            // 
            ...
            label3.TabIndex = 20;
            label3.Text = "Actualiza el nombre:";
            // 
            // label4
            // 
            label4.AutoSize = true;
            label4.Location = new Point(323, 57);
            label4.Name = "label4";
            label4.Size = new Size(106, 15);
            label4.TabIndex = 21;
            label4.Text = "Actualiza la marca:";
            // 
            // label5
            // 
            label5.AutoSize = true;
            label5.Location = new Point(323, 128);
            label5.Name = "label5";
            ...
            label7.Location = new Point(324, 276);
            label7.Name = "label7";
